...
input3['T1_C'] = fuzz.smf(output.universe, 37.7 , 38)
...
output['T1'] = fuzz.smf(output.universe, 37.7 , 38)
...
rule2 = ctrl.Rule(input1['Q2'] & input2['H2_3'] & input3['T2_3_C'],  output['T2_3'])
rule3 = ctrl.Rule(input1['Q3'] & input2['H2_3'] &  input3['T2_3_C'], output['T2_3'])
rule4 = ctrl.Rule(input1['Q4'] & input2['H4_5'] &  input3['T4_C'], output['T4'])
rule5 = ctrl.Rule(input1['Q5'] & input2['H4_5'] & input3['T5_C'] , output['T5'])
...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def validate_data(self, Humidity , Temperature , Day):
        ...
        if int(Day) == 1 or int(Day) == 2:
            print("Day one!")
            if((Humidity >= 61 and Humidity <= 64) and (Temperature >= 37.7 and Temperature <= 38.3 )):
                validation = True
                print("Valid data!")
            else:
                validation = False
            ...
            if((Humidity >= 50 and Humidity <= 54) and (Temperature >= 37.5 and Temperature <= 38.1 )):
                validation = True
            else:
                validation = False
                self.error_dialog("Invalid data !")
        elif int(Day) == 6 or int(Day) == 7 or int(Day) == 8 or int(Day) == 9 or int(Day) == 10:
            if((Humidity >= 50 and Humidity <= 54) and (Temperature >= 37.3 and Temperature <= 37.7 )):
                validation = True
            else:
                validation = False
                self.error_dialog("Invalid data !")
        elif int(Day) == 11 or int(Day) == 12 or int(Day) == 13 or int(Day) == 14 or int(Day) == 15:
            if((Humidity >= 38 and Humidity <= 42) and (Temperature >= 36.8 and Temperature <= 37.6 )):
                validation = True
            else:
                validation = False
                self.error_dialog("Invalid data !")
        elif int(Day) == 16 or int(Day) == 17 or int(Day) == 18 :
            if((Humidity >= 38 and Humidity <= 42) and (Temperature >= 36.6 and Temperature <= 37.0 )):
                validation = True
            else:
                validation = False
                self.error_dialog("Invalid data !")
    ...
    def get_values(self ):
        ...
        print(self.validate_data(humidity,current_temperature,day))
